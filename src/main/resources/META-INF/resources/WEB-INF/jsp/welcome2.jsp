                                        ...
                                        <img alt="" height="200" width="200" src="data:image/jpg;base64, ${product.base64Picture}" />
       									...
       									<div class="product-body">
                                            <c:forEach items="${product.translations}" var="translation">
                                                <h3 class="product-name"><a href="#"><c:out value="${translation.translation}"/></a></h3>
                                            </c:forEach>
       										<h4 class="product-price"><c:out value="${product.price}"/>€</h4>
       									</div>
       									<div class="add-to-cart">
       										<button class="add-to-cart-btn" onclick="addProductToCart(${product.id})"><i class="fa fa-shopping-cart"></i> add to cart</button>
       									</div>
       								</div>
       							</div>
                    </c:forEach>
